...
~~~sh
git clone git@github.com:nko3/script.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-script --password 8puvhCKZeyh7TslY
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/script" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280619
[3]: https://github.com/nko3/script
